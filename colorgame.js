...
var numSquares = 6;
var colors = []; //var for random colors
    ...
    for(var i=0; i<squares.length; i++){
        ...
        squares[i].addEventListener('click', function(){
            ...
            if(clickedColor === pickedColor){
                ...
                modeButtons.classList.add('selected').style.backgroundColor = clickedColor;
...
//change all squares colors to corrrect color when picked a correct square
